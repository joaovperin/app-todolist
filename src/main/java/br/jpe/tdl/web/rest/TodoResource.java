...
import br.jpe.tdl.service.TodoQueryService;
...
import br.jpe.tdl.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link br.jpe.tdl.domain.Todo}.
 */
@RestController
@RequestMapping("/api")
public class TodoResource {
     ...
     */
    @GetMapping("/todos")
    public ResponseEntity<List<TodoDTO>> getAllTodos(TodoCriteria criteria) {
        log.debug("REST request to get Todos by criteria: {}", criteria);
        List<TodoDTO> entityList = todoQueryService.findByCriteria(criteria);
